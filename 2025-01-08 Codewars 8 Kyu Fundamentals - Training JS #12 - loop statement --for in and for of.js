// 1/8/25 Wednesday Codewars 8 Kyu Fundamentals - Training JS #12: loop statement --for..in and for..of
...
// 2nd attempt - not working, used key[value] instead of obj[key]
function giveMeFive(obj) {
    const fives = [];
...
// 1st attempt - not working, split looping through object and renaming key to value didn't do anything.
function giveMeFive(obj) {
    const fives = [];
