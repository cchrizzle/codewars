// 12/9/23 Saturday Codewars 8 Kyu Fundamentals - Welcome!
...
function greet(language) {
  ...
  defaultLanguage = 'english';      // I like how this one specifies a default language to make it more flexible and readable
