// 3/22/24 Friday Codewars 8 Kyu Fundamentals - Training JS #10: loop statement --for
...
Other Solutions
============= */
// Other solution 1 - real cool setup with tertiary
function pickIt (arr) {
...
// Other solution 2 - proper formatting of my first try
function pickIt(arr){
    var odd=[],even=[]
    //coding here
