// 12/31/23 Sunday Codewars 8 Kyu Fundamentals - Training JS #6: Basic data types--Boolean and conditional statements if..else
...
// 1st attempt - not passing all tests
function trueOrFalse(val){
    let a = 1;
    let b = 2;
    let c = 1;
